...
import com.tcv.vassistchat.adapters.recyclerView.calls.CallsDetailsAdapter;
...
import com.tcv.vassistchat.presenters.calls.CallsPresenter;
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected void onPostExecute(Bitmap bitmap) {
                ...
                if (bitmap != null) {
                    ...
                    Glide.with(CallDetailsActivity.this)
                            .load(EndPoints.ROWS_IMAGE_URL + ImageUrl)
                            .asBitmap()
                            .centerCrop()
                            .transform(new CropCircleTransformation(CallDetailsActivity.this))
