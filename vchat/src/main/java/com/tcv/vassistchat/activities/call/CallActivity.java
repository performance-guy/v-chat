...
import com.tcv.vassistchat.helpers.call.PeerConnectionParameters;
import com.tcv.vassistchat.helpers.call.WebRtcClient;
import com.tcv.vassistchat.helpers.images.BlurTransformationPicasso;
import com.tcv.vassistchat.models.calls.CallPusher;
...
/**
 * Created by Salman Saleem on 10/20/16.
 *
 *
            ...
            runOnUiThread(() -> {
                ...
                switch (bandwidthState) {
                    ...
                    case POOR:
                        ...
                        AppHelper.CustomToast(WhatsCloneApplication.getInstance(), getString(R.string.you_are_using_a_poor_connection));
                        new Handler().postDelayed(() -> {
                            connectionStatus.setVisibility(View.GONE);
                        }, 4000);
                        break;
