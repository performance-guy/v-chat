...
import com.tcv.vassistchat.activities.media.ImagePreviewActivity;
import com.tcv.vassistchat.activities.popups.VideoPlayerActivity;
...
public class AppHelper {
    ...
    public static void ExportRealmDatabase(Context mContext) {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, "salman@gmail.com");
    ...
    public static void restartService() {
        ...
        WhatsCloneApplication.getInstance().startService(new Intent(WhatsCloneApplication.getInstance(), MainService.class));
    }
