...
public class WebRtcClient {
    ...
    public void signalingServer(String to, String type, JSONObject payload) throws JSONException {
        ...
        message.put("to", to);
        message.put("from", PreferenceManager.getSocketID(WhatsCloneApplication.getInstance()));
            ...
            try {
                ...
                mSocket.emit(AppConstants.SOCKET_RESET_SOCKET_ID, message, (Ack) args -> {
                    ...
                    try {
                        ...
                        if (!id.equals(PreferenceManager.getSocketID(WhatsCloneApplication.getInstance()))) {
                            mActivity.finish();
                        } else {
