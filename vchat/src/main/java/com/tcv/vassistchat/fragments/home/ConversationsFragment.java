...
import com.tcv.vassistchat.adapters.recyclerView.messages.ConversationsAdapter;
...
import com.tcv.vassistchat.presenters.messages.ConversationsPresenter;
...
import static com.tcv.vassistchat.app.AppConstants.EVENT_BUS_ACTION_MODE_FINISHED;
import static com.tcv.vassistchat.app.AppConstants.EVENT_BUS_CONTACTS_PERMISSION;
import static com.tcv.vassistchat.app.AppConstants.EVENT_BUS_CREATE_NEW_GROUP;
...
import static com.tcv.vassistchat.app.AppConstants.EVENT_BUS_IMAGE_GROUP_UPDATED;
...
import static com.tcv.vassistchat.app.AppConstants.EVENT_BUS_NEW_MESSAGE_CONVERSATION_NEW_ROW;
...
import static com.tcv.vassistchat.app.AppConstants.EVENT_UPDATE_CONVERSATION_OLD_ROW;

/**
 * Created by Salman Saleem  on 20/01/2016.
 *
 */
public class ConversationsFragment extends Fragment implements LoadingData, RecyclerView.OnItemTouchListener, ActionMode.Callback {
    ...
    public void sendGroupMessage(GroupsModel groupsModel, MessagesModel messagesModel) {
        Realm realmCreateGroup = WhatsCloneApplication.getRealmDatabaseInstance();
